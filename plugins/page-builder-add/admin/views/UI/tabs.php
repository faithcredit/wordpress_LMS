  ...
  <div class="pluginops-tab-content pb_editor_tab_content" style="overflow: hidden; background: #fff;">
    <div id="tab1" class="pluginops-tab pluginops-active" style="background: #fff;">
      ...
      <div id="top-optionsBar">
        ...
        <div class="topOptionBarDivider" style="width: 28%;">
          <?php echo "$goProLink"; ?>
        ...
        <div class="topOptionBarDivider extraTopBarSpaceDividerTwo" style="width: 7%; height: 2px;"></div>
    ...
    <!-- <div class="addNewWidgetContainer" style="">
      ...
      <div class="pb_fullScreenEditorButton" > Open Editor <span class="dashicons dashicons-editor-expand"></span> </div>
