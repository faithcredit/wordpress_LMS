...
if ($pluginops_tracking_consent == true) {
  ...
  <!-- Google tag (gtag.js) --> <script async src="https://www.googletagmanager.com/gtag/js?id=AW-11225995301"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-11225995301'); </script>
  

  <!-- Event snippet for Plugin Install - LPB conversion page --> <script> gtag('event', 'conversion', {'send_to': 'AW-11225995301/u8h1CLff-K4YEKWw_Ogp'}); </script>
