...
/**
 * Elementor WooCommerceAddToCartButton
 *
 * Elementor widget for team vision
 *
 * @since 1.0.0
 */
class WooCommerceAddToCartButton extends Widget_Base {
	...
	public function get_name() {
		return 'woocommerceaddtocartbutton';
	}
	...
	public function get_title() {
		return esc_html__( 'WooCommerce Add To Cart Button', 'elementorwidgetsmegapack' );
	}
	 ...
	 */
	private function grid_get_all_woocommerce_products() {
		$options = array();
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'button_type',
			[
				'label' => esc_html__( 'Cart Button Type', 'elementorwidgetsmegapack' ),
		...
		$this->add_control(
			'product_id',
			[
				'label' => esc_html__( 'Select Product', 'woocommerceproductsdisplayelementor' ),
				'type' => Controls_Manager::SELECT,
				'options' => $this->grid_get_all_woocommerce_products()			
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'woocommerceaddtocartbutton-icon-hidden',
				'options' => [
					'woocommerceaddtocartbutton-icon-hidden'	=> esc_html__( 'Hidden', 'elementorwidgetsmegapack' ),
					'woocommerceaddtocartbutton-icon-show'	=> esc_html__( 'Show', 'elementorwidgetsmegapack' )				]
			]
		);	
		...
		$this->add_control(
			...
			[
				...
				'condition'	=> [
					'button_icon_show'	=> 'woocommerceaddtocartbutton-icon-show'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'woocommerceaddtocartbutton-font-default',
				'options' => [
					'woocommerceaddtocartbutton-font-default'	=> esc_html__( 'Default Site', 'elementorwidgetsmegapack' ),
					'woocommerceaddtocartbutton-google-font' 	=> esc_html__( 'Google Fonts Custom', 'elementorwidgetsmegapack' )				
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'condition'	=> [
					'button_font_type'	=> 'woocommerceaddtocartbutton-google-font'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'woocommerceaddtocartbutton-align-center',
				'options' => [
					'woocommerceaddtocartbutton-align-center'	=> esc_html__( 'Center', 'elementorwidgetsmegapack' ),
					'woocommerceaddtocartbutton-align-left' 		=> esc_html__( 'Left', 'elementorwidgetsmegapack' ),				
					'woocommerceaddtocartbutton-align-right' 	=> esc_html__( 'Right', 'elementorwidgetsmegapack' )				
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'woocommerceaddtocartbutton-border-square',
				'options' => [
					'woocommerceaddtocartbutton-border-square'	=> esc_html__( 'Square', 'elementorwidgetsmegapack' ),
					'woocommerceaddtocartbutton-border-round' 	=> esc_html__( 'Round', 'elementorwidgetsmegapack' )				
				],
				'condition'	=> [
					'button_type'	=> array(
											'bg-none-button-mini', 
	...
	protected function render() {
		...
		$product_id 							= esc_html($settings['product_id']);
		...
		if(empty($button_border_style)) { $button_border_style = 'solid'; }
		...
		// Google Fonts
		if($button_font_type == 'woocommerceaddtocartbutton-google-font') :
		
			$css_a_inline .= 'font-family: ' . $google_fonts . ';';   
			$css_a_view_cart .= 'font-family: ' . $google_fonts . ';';   
		...
		$css_a_view_cart .= 'font-size:'.esc_html($button_size).';';
		...
		if(	$button_type == 'flat-button-mini' || 
			...
			$css_a_view_cart .= 'color:'.esc_html($button_text_color).';
							  background:'.esc_html($button_background_color).';
							  border-color:'.esc_html($button_background_color).';
							  border-style:'.esc_html($button_border_style).';';
							  
			$css_style_to_append = '<style>
			.woocommerceaddtocartbutton-button.'.esc_html($button_type).'.woocommerceaddtocartbutton-button-'.esc_html($instance).' a:hover {
			...
			.woocommerceaddtocartbutton-button.'.esc_html($button_type).'.woocommerceaddtocartbutton-button-'.esc_html($instance).' a.added_to_cart {
				'.$css_a_view_cart.'
			}
			</style>';
		endif;
		...
		if($button_position == 'fixed') {
			$position_button = 'woocommerceaddtocartbutton-fixed';
			$position_button_bt = 'woocommerceaddtocartbutton-fixed-'.esc_html($button_position_bt).'';
		...
		$data_value = 'data-woocommerceaddtocartbutton-custom-css="'.$css_style_to_append.'"';
		
				
		$inline_block = '';
		if($button_display == 'inline-block') {
			$inline_block .= 'woocommerceaddtocartbutton-inline-block';
		}
		
		echo '<span '.$css_container_inline.' '.$data_value.' class="woocommerceaddtocartbutton-button woocommerceaddtocartbutton-custom-js '.esc_html($button_type).' '.esc_html($inline_block).' '.esc_html($position_button).' '.esc_html($position_button_bt).' '.esc_html($button_border_type).' '.esc_html($button_align).' woocommerceaddtocartbutton-button-'.esc_html($instance).ewmp_animate_class($addon_animate,$effect,$delay).'>';
			echo '<a class="product_type_simple add_to_cart_button ajax_add_to_cart" '.$css_a_inline.' data-product_sku="" data-product_id="'.$product_id.'" rel="nofollow" href="?add-to-cart='.$product_id.'">';
				
			if($button_icon_show == 'woocommerceaddtocartbutton-icon-show') {
