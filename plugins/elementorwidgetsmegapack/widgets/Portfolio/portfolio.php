 ...
 * @since 1.0.0
 */
class FPG_Portfolio extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'FPG Portfolio', 'elementorwidgetsmegapack' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'colosseo',
				'options' => [
					'colosseo' 			=> esc_html__('Colosseo', 'elementorwidgetsmegapack' ),
					'piazzavenezia' 	=> esc_html__('Piazza Venezia', 'elementorwidgetsmegapack' ),
					'sanpietro' 		=> esc_html__('San Pietro', 'elementorwidgetsmegapack' ),
					'portamaggiore' 	=> esc_html__('Porta Maggiore', 'elementorwidgetsmegapack' ),
					'piazzadispagna' 	=> esc_html__('Piazza Di Spagna', 'elementorwidgetsmegapack' ),
					'cappellasistina' 	=> esc_html__('Cappella Sistina', 'elementorwidgetsmegapack' ),
					'piazzanavona' 		=> esc_html__('Piazza Navona', 'elementorwidgetsmegapack' )
				]
			]
		);
	...
	protected function render() {
		...
		echo '<style type="text/css">';
			...
			if($custom_style == 'off') :
				if($skin == 'colosseo') {$fonts = 'google_fonts'; $gfonts = 'Open Sans'; 	$title_fs = '20';
				...
				if($skin == 'piazzavenezia') {$fonts = 'google_fonts'; $gfonts = 'Open Sans'; 	$title_fs = '26';
				...
				if($skin == 'sanpietro') {$fonts = 'google_fonts'; $gfonts = 'Open Sans'; 	$title_fs = '18';
				...
				if($skin == 'piazzadispagna') {$fonts = 'google_fonts'; $gfonts = 'Open Sans'; 	$title_fs = '24';
				...
				if($skin == 'portamaggiore') {$fonts = 'google_fonts'; $gfonts = 'Open Sans'; 	$title_fs = '20';
				...
				if($skin == 'cappellasistina') {$fonts = 'google_fonts'; $gfonts = 'Open Sans'; 	$title_fs = '22';
				...
				if($skin == 'piazzanavona') {$fonts = 'google_fonts'; $gfonts = 'Open Sans'; 	$title_fs = '22';
		...
		echo '<div class="fpg-general-container fpg-filter-'.esc_html($filter).' fpg-container-number-'.esc_html($instance).' fpg-type-portfolio '.esc_html($skin).'">';
		...
		echo '<div class="fpg-container fpg-type-portfolio grid-columns-'.esc_html($columns).' fpg-grid fpg-icon  fpg-'.esc_html($instance).' '.esc_html($skin).' '.esc_html($grid_masonry).' '.ewmp_animate_class($addon_animate,$effect,$delay).'>';
		...
		/************** #FILTER ***************/
				...
				if($skin == 'colosseo') {
					...
					echo '<div class="fpg-container-portfolio">
								<h1 class="fpg-title">'.get_the_title().'</h1>
								<p class="fpg-text">'.ewmp_get_blogs_excerpt($num_excerpt,'no','').'...<br></p>
								<p class="fpg-info">'.ewmp_post_info($show_date,$show_comments,$show_author,$show_category,$show_views,$source,$posts_type,'F j, Y').'</p>							
								<a href="'.esc_url($link).'" class="fpg-read-more">'.esc_html__('View more','elementorwidgetsmegapack').'</a>
							</div>';	
				}
			if($skin == 'piazzavenezia') {
				...
				echo '<div class="fpg-container-portfolio">
								<h1 class="fpg-title">'.get_the_title().'</h1>
								<p class="fpg-info-date">'.ewmp_post_info($show_date,false,false,false,false,$show_views,$source,'F j, Y').'</p>															
								<p class="fpg-text">'.ewmp_get_blogs_excerpt($num_excerpt,'no','').'<br></p>
								<p class="fpg-info">'.ewmp_post_info(false,$show_comments,$show_author,$show_category,$show_views,$source,$posts_type,'F j, Y').'</p>							
								<a href="'.esc_url($link).'" class="fpg-read-more">'.esc_html__('View more','elementorwidgetsmegapack').'</a>
							</div>';	
			}	
			if($skin == 'sanpietro') {
			...
			if($skin == 'portamaggiore') {
				echo '<div class="fpg-image-container">';
				echo ewmp_get_thumb($grid_masonry);
				echo '<div class="fpg-image-over">
			...
			if($skin == 'piazzadispagna') {
				...
				echo '<div class="fpg-image-over">
							...
							<div class="fpg-container-portfolio">
								<p class="fpg-info">'.ewmp_post_info($show_date,$show_comments,$show_author,$show_category,$show_views,$source,$posts_type,'F j, Y').'</p>						
								<p class="fpg-text">'.ewmp_get_blogs_excerpt($num_excerpt,'no','').'</p>								
							</div>';	
			} 
			if($skin == 'cappellasistina') {				
				echo '<div class="fpg-image-container"><div class="fpg-header-container">';
				echo '<span class="fpg-info-date">'.ewmp_post_info($show_date,false,false,false,false,$source,$posts_type,'F j, Y').'</span>';				
				echo ewmp_get_thumb($grid_masonry);
				echo '<h1 class="fpg-title">'.get_the_title().'</h1></div>';
				echo '<div class="fpg-image-over"><a href="'.esc_url($link).'" class="icon-plus fa fa-plus"></a>
							</div></div>			
							<div class="fpg-container-portfolio">
								<p class="fpg-info">'.ewmp_post_info(false,$show_comments,$show_author,$show_category,$show_views,$source,$posts_type,'F j, Y').'</p>						
								<p class="fpg-text">'.ewmp_get_blogs_excerpt($num_excerpt,'no','').'</p>
								<p class="fpg-share">'.ewmp_share($skin).'</p>								
							</div>';	
			} 	
			if($skin == 'piazzanavona') {				
				echo '<div class="fpg-image-container">
								<div class="fpg-header-container">
								<p class="fpg-share">'.ewmp_share($skin).'</p>';				
						echo ewmp_get_thumb($grid_masonry);
				echo '</div>';
				echo '<div class="fpg-image-over">
							...
							<div class="fpg-container-portfolio">
								...
								<p class="fpg-text">'.ewmp_get_blogs_excerpt($num_excerpt,'no','').'</p>
								<p class="fpg-info-date">'.ewmp_post_info($show_date,false,false,false,false,$show_views,$source,'F j, Y').'</p>				
								<a href="'.esc_url($link).'" class="fpg-read-more">'.esc_html__('Read More >>','elementorwidgetsmegapack').'</a>								
							</div>';	
			} 			 				
