 ...
 * @since 1.0.0
 */
class Team_Vision_Style4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team Vision Style 4', 'elementorwidgetsmegapack' );
	}
	...
	protected function render() {
		...
		if($custom_style == 'on') :
			...
			.teamvision-team-style4-".esc_html($instance)." .teamvision-team-name, 
			.teamvision-team-style4-".esc_html($instance)." .teamvision-team-container-wrap span.teamvision-team-name { color:".esc_html($title_color).";}
			.teamvision-team-style4-".esc_html($instance)." .teamvision-team-container-wrap span.teamvision-team-role { color:".esc_html($role_color).";}
			.teamvision-team-style4-".esc_html($instance)." .teamvision-team-social-container a { color:".esc_html($social_color).";}
			.teamvision-team-style4-".esc_html($instance)." a:hover { color:".esc_html($h_color)."; }
			</style>";
			...
			echo '<div '.$data_value.' class="teamvision teamvision-team-style4 teamvision-team-col-'.esc_html($columns).' teamvision-team-style4-'.esc_html($instance).' '.esc_html($js_class).'">';
