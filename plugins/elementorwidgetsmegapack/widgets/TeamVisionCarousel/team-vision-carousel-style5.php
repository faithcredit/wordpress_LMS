 ...
 * @since 1.0.0
 */
class Team_Vision_Carousel_Style5 extends Widget_Base {
	...
	public function get_name() {
		return 'team-vision-carousel-style5';
	}
	...
	public function get_title() {
		return esc_html__( 'Team Vision Carousel Style 5', 'elementorwidgetsmegapack' );
	}
	...
	protected function render() {
		...
		if($custom_style == 'on') :
			...
			.teamvision-team-carousel-style5-".esc_html($instance)." .teamvision-team-name, 
			.teamvision-team-carousel-style5-".esc_html($instance)." .teamvision-team-container-wrap span.teamvision-team-name { color:".$title_color.";}
			.teamvision-team-carousel-style5-".esc_html($instance)." .teamvision-team-container-wrap span.teamvision-team-role { color:".$role_color.";}
			.teamvision-team-carousel-style5-".esc_html($instance)." .teamvision-team-social-container a { color:".esc_html($social_color).";}
			.teamvision-team-carousel-style5-".esc_html($instance)." a:hover { color:".esc_html($h_color)."; }
			.teamvision-team-owl-carousel.teamvision-team-carousel-style5-".esc_html($instance).".owl-theme .owl-controls .owl-nav [class*=owl-]:hover { color:".esc_html($nav_h_color)."; background:".$nav_bg_h_color.";}
			.teamvision-team-owl-carousel.teamvision-team-carousel-style5-".esc_html($instance).".owl-theme .owl-controls .owl-nav [class*=owl-] { color:".esc_html($nav_color)."; background:".esc_html($nav_bg_color).";}
			.teamvision-team-owl-carousel.teamvision-team-carousel-style5-".esc_html($instance).".owl-theme .owl-dots .owl-dot span { background:".esc_html($nav_bg_color).";}
			</style>";
			...
			echo '<div '.$data_value.'
							...
							class="teamvision teamvision-team-owl-carousel teamvision-team-carousel-style5 teamvision-team-carousel-col-'.esc_html($item_show).' teamvision-team-carousel-style5-'.esc_html($instance).' '.esc_html($js_class).'">';
