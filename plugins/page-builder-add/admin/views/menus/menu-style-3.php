...
<?php echo "#lpb_menu_widget"; ?> ul{
	list-style:none;
	margin:0;
	padding:0
}

<?php echo "#lpb_menu_widget"; ?> ul a{
	display:block;
...
<?php echo "#lpb_menu_widget"; ?> ul li{
	position:relative;
	float:left;
	margin:0;
}

<?php echo "#lpb_menu_widget"; ?> ul li.current-menu-item{
	background:#ddd;

}

<?php echo "#lpb_menu_widget"; ?> ul a:hover{
	color: #8e8c8c;
}

<?php echo "#lpb_menu_widget"; ?> ul ul{
	display:none;
	position:absolute;
	top:100%;
	left:0;
...
<?php echo "#lpb_menu_widget"; ?> ul ul li{
	float:none;
	width:200px;
}

<?php echo "#lpb_menu_widget"; ?> ul ul a{
}

<?php echo "#lpb_menu_widget"; ?> ul ul ul{
	top:0;
	left:100%
}

<?php echo "#lpb_menu_widget"; ?> ul li:hover > ul{
	display:block;
}
...
@media screen and (max-width: 780px) {
	...
	<?php echo "#lpb_menu_widget"; ?>{ display: none; }
	#pb-nav-res-button {display: block; margin-left: 3%;}

	<?php echo "#lpb_menu_widget"; ?>{
		text-align: left;
		float: left;
		margin-left: 10%;
		width:60%;
...
(function($){
	$('.navBtnImg').click(function(){
		$('<?php echo "#lpb_menu_widget"; ?>').show();
		$('.navBtnImg').hide();
		$('.navBtnImgActive').show();
	});
	$('.navBtnImgActive').click(function(){
		$('<?php echo "#lpb_menu_widget"; ?>').hide();
