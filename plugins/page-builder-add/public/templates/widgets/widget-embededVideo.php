<?php  if ( ! defined( 'ABSPATH' ) ) exit;
  ...
  if ($widgetEvidVideoType == 'youtube') {
    ...
    if ($widgetEvidImageOverlay == 'true') {
      $widgetEvidVideoAutoplay = '?autoplay=1&mute=1';
    }

    $widgetEvidVideoAutoplay = ($widgetEvidVideoAutoplayPrev == 'true') ? '?autoplay=1&mute=1' : '?autoplay=0';
    ...
    $videoIframeURL = 'https://www.youtube.com/embed/'.$widgetEvidVideoLink.$widgetEvidVideoAutoplay.'&amp;rel='.$widgetEvidVideoSuggested.'&amp;showinfo='.$widgetEvidVideoTitle.'&amp;controls='.$widgetEvidVideoPlayerControls;
