 ...
 *
 * Elementor WooCommerce Sale Products Layout Widget
 *
 * @since 1.0.0
 */
class Woocommerce_Sale_Products_Display extends Widget_Base {
	...
	public function get_name() {
		return 'woocommerce-sale-products-display';
	}
	...
	public function get_title() {
		return esc_html__( 'WooCommerce Sale Products Layout', 'elementorwidgetsmegapack' );
	}
	...
	protected function render() {
		...
		if($columns == '1') : $columns_class = 'col-xs-12'; $container_class = 'woocommercesaleproductsdisplay-bp-vc-blogs-1-col'; endif;
		if($columns == '2') : $columns_class = 'col-xs-6'; $container_class = 'woocommercesaleproductsdisplay-bp-vc-blogs-2-col'; endif;
		if($columns == '3') : $columns_class = 'col-xs-4'; $container_class = 'woocommercesaleproductsdisplay-bp-vc-blogs-3-col'; endif;		
		...
		if($pagination == 'load-more') : 
			$class_load_more = 'woocommercesaleproductsdisplay-bp-load-more-'.$blog_style.''; 
			$class_item_load_more = 'woocommercesaleproductsdisplay-bp-item-load-more-'.$blog_style.'';
		endif;
		// #Load More
		...
		echo '<div class="woocommercesaleproductsdisplay woocommercesaleproductsdisplay-bp-vc-element-blogs '.esc_html($class_load_more).' woocommercesaleproductsdisplay-bp-blogs-'.$blog_style.' '.esc_html($container_class).' woocommercesaleproductsdisplay-bp-vc-element-blogs-'.esc_html($instance).' element-no-padding">';
		
		echo '<div class="woocommercesaleproductsdisplay-bp-vc-element-blogs-article-container">';
		...
		if($pagination == 'load-more') : 
			...
			wp_enqueue_script(
				'woocommercesaleproductsdisplay-bp-load-blogs',
				EWMP_URL . 'assets/js/woocommercesaleproductsdisplay-loadmore.js',
				array('jquery'),
				'1.0',
				true
			);		
		...
		/**********************************************************************/ 
		if($pagination == 'yes') {
				echo '<div class="clearfix"></div><div class="woocommercesaleproductsdisplay-bp-blogs-display-'.esc_html($instance).' woocommercesaleproductsdisplay-bp-vc-pagination">';
				if($pagination_type == 'numeric') {
					echo ewmp_posts_numeric_pagination($pages = '', $range = 2,$loop,$paged,$css_current_pag_num,$css_link);
				} else {
					echo '<div class="woocommercesaleproductsdisplay-bp-pagination-normal">';
